...
type Props = {
  ...
  const Placed = async ({ params: { slug } }: Props) => {
...
<div className="mb-15 lg:mb-20 xl:mb-24 sm:mb-5 md:mb10 bg-white rounded-lg overflow-hidden shadow-lg transition duration-300 ease-in-out hover:scale-110">
  <img className="w-36 rounded-lg shadow-lg mb-6 mx-auto" src="https://mdbootstrap.com/img/Photos/Avatars/img%20(9).jpg"
    alt="avatar"  />
  <h5 className="text-lg font-bold mb-4 text-center">Alan Turing</h5>
  <p className="mb-6 text-center">{placed.sdatas.position}</p>
